...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-24 px-6 md:px-12 lg:px-20 relative" ref={ref}>
      {/* Decorative elements */}
      <div className="absolute top-1/2 right-0 w-[400px] h-[400px] rounded-full border border-white/5 translate-x-1/2 -translate-y-1/2" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <span className="font-code text-muted-foreground text-sm">... /About me ...</span>
          <h2 className="font-code text-2xl md:text-3xl mt-4 text-foreground">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] rounded-3xl overflow-hidden bg-card-elevated relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-muted to-card flex items-center justify-center">
                <div className="text-center">
                  <div className="w-32 h-32 rounded-full bg-muted-foreground/20 mx-auto mb-4 flex items-center justify-center">
                    <span className="font-code text-4xl text-muted-foreground">👤</span>
                  </div>
                  <p className="font-code text-sm text-muted-foreground">Your Photo Here</p>
                </div>
              </div>
